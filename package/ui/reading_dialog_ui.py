...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.back_button.setGeometry(QtCore.QRect(470, 850, 75, 24))
        self.back_button.setObjectName("back_button")
        self.next_button = QtWidgets.QPushButton(parent=Dialog)
        self.next_button.setGeometry(QtCore.QRect(590, 850, 75, 24))
        self.next_button.setObjectName("next_button")
        self.page_image = QtWidgets.QLabel(parent=Dialog)
        self.page_image.setGeometry(QtCore.QRect(18, 15, 1081, 831))
